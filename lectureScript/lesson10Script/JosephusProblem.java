...
public class JosephusProblem
{
	...
	{	
		...
		//Filling the circle with men
		for (int i = 1; i <= circleSize; i++)
		{
			circle.add(i);
		}
		
		//Getting the iterator to traverse the list
	 ...
	 */
	private Iterator<Integer> closeCircle(Iterator<Integer> ringIter, LinkedList<Integer> circle)
	{
